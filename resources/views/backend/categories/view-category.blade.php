            ...
            <div class="col-12">
              <div class="card">
                <div class="card-header">
                  ...
                  <a href="{{route('category.create')}}"  class="btn btn-success btn-sm float-right"><i class="fa fa-plus-circle"></i>Add Category</a>
                  ...
                  <table id="example2" class="table table-bordered table-hover">
                    ...
                    <tbody>
                      @foreach ($allData as $category)
                        ...
                        <td><img src="{{asset('backend/images/categories/'.$category->image)}}" alt="" width="100"></td>
                        <td>
